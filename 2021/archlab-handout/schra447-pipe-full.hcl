...
# ID: 4949830                                                      #
# x500: schra447                                                   #
# Added iaddq to list of valid registers, list of icodes
# having register bytes, list of icodes having constant word bytes, and
# list of icodes using d_rB as the b source and the E destination.
# Also made iaddq icode having input A  = to the E_valC and to use
# the E_valB as input b. Finally I had to add a check to "E_icode in 
# {IIADDQ, IOPQ} to the set cc section to make sure IIADDQ sets the
# condition codes. Otherwise no other implementations were made.
####################################################################
...
bool need_regids =
	f_icode in { IRRMOVQ, IIADDQ, IOPQ, IPUSHQ, IPOPQ, 
